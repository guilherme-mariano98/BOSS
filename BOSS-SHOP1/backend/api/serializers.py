...
from .models import Category, Product, Order, OrderItem, Address, PaymentMethod, NotificationPreference
...
class UserSerializer(serializers.ModelSerializer):
    ...
    def update(self, instance, validated_data):
        # Only update first_name, last_name, and additional profile fields
