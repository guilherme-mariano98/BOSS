// Carrinho de compras - REMOVIDO (conflito com implementação no index.html)
// let cart = [];

// Carregar carrinho do localStorage ao iniciar - COMENTADO (feito no index.html)
/*
...
// Função para adicionar produto ao carrinho - COMENTADA (conflito com nova implementação)
/*
...
// Função para mostrar modal de login - COMENTADA (não mais necessária)
/*
...
// Atualizar contador do carrinho - COMENTADO (conflito com implementação no index.html)
/*
...
function setupFavorites() {
    ...
    document.querySelectorAll('.product-card').forEach((card, index) => {
        ...
        const productName = nameEl ? nameEl.textContent : 'Produto';
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const typeWriter = () => {
        if (heroTitle && currentIndex < originalText.length) {
...
function toggleFullScreen() {
    ...
    if (!document.fullscreenElement) {
        ...
        span.textContent = 'Sair Tela Cheia';
    } else {
...
// Update user icon based on login status// This function is now in auth-utils.js to avoid duplication
// document.addEventListener('DOMContentLoaded', function() {
//     updateUserIcon();
// });
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelectorAll('.product-card').forEach(card => {
        card.addEventListener('click', function(e) {
            ...
            const nameEl = this.querySelector('h4, h3');
            const productName = nameEl ? nameEl.textContent : 'Produto';
